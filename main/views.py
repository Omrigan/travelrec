...
def getTagsForText(req, pk):
    ...
    ldamodel = gensim.models.ldamodel.LdaModel.load("supermodel.txt")
    for top in ldamodel.print_topics(num_words=5):
          print(top)
    return HttpResponse(ldamodel[dictionary.doc2bow(tokens)])
